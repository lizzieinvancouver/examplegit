...
// Code below includes pooled slopes at all levels, unpooled intercepts at site level and pooled intercepts at plot level
...
model {
 ...
 // a_site ~ normal(mu_a,sig_a); // turn off pooling of intercepts at site level
