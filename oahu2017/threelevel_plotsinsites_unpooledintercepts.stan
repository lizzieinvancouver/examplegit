...
// Code below includes unpooled intercepts at all levels and pooled slopes at all levels (and assumes that all sites have the same within-site (plot-to-plot) variance).  
